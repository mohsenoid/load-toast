...
class MaterialProgressDrawable(context: Context, private val mAnimExcutor: View) : Drawable(), Animatable {
    ...
    private val mCallback: MaterialProgressDrawableCallback = object : MaterialProgressDrawableCallback {
    ...
    private class Ring(private val mCallback: MaterialProgressDrawableCallback) {
        ...
        var insets = 2.5f
            private set
        private var mColors = IntArray(0)
    ...
    interface MaterialProgressDrawableCallback : Callback {
        fun invalidateDrawable()
    }
}
